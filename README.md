...
O desenvolvimento do Resonance é regido pela [Constituição do Projeto](Resonance-Player/CONSTITUTION.md):
...
Toda a documentação técnica, decisões de produto e governança estão disponíveis no diretório [`Resonance-Player/`](Resonance-Player/):

- 💡 [**IDEIA.md**](Resonance-Player/IDEIA.md) — Visão de produto, contexto histórico, auditoria inicial e direcionamento estratégico.
- 📋 [**PRD.md**](Resonance-Player/PRD.md) — Documento de Requisitos de Produto (requisitos funcionais, cenários e critérios de aceite).
- 🧩 [**FEATURES_SUGERIDAS_SPEC_KIT.md**](Resonance-Player/FEATURES_SUGERIDAS_SPEC_KIT.md) — Catálogo de features e guardrails obrigatórios para o Spec Kit.
- 📜 [**CONSTITUTION.md**](Resonance-Player/CONSTITUTION.md) — Constituição do projeto e regras de arquitetura (cópia legível de `.specify/memory/constitution.md`).
- 🎨 [**BRANDING.md**](Resonance-Player/BRANDING.md) — Posicionamento de marca, taglines e diretrizes de identidade visual.
- 🚀 [**SPEC_KIT_HANDOFF.md**](Resonance-Player/SPEC_KIT_HANDOFF.md) — Guia prático de inicialização e comandos para o fluxo Spec Kit.
