...
public partial class AlbumViewViewModel : SongListViewModelBase
{
    ...
    {
        AlbumTitle = Resonance.WinUI.Resources.Strings.AlbumView_DefaultAlbumTitle;
        ArtistName = Resonance.WinUI.Resources.Strings.AlbumView_DefaultArtistName;
    ...
    private void HandleAlbumNotFound(Guid albumId)
    {
        ...
        AlbumTitle = Resonance.WinUI.Resources.Strings.AlbumView_AlbumNotFound;
        PageTitle = Resonance.WinUI.Resources.Strings.Generic_NoItems;
        ArtistName = string.Empty;
        AlbumArtists = new List<AlbumArtist>();
        CoverArtUri = null;
        Songs.Clear();
        TotalItemsText = ResourceFormatter.Format(Resonance.WinUI.Resources.Strings.Songs_Count_Plural, 0);
    }

    private void HandleLoadError(Guid albumId, Exception ex)
    {
        _logger.LogError(ex, "Failed to load album with ID {AlbumId}", albumId);
        AlbumTitle = Resonance.WinUI.Resources.Strings.AlbumView_Error;
        PageTitle = Resonance.WinUI.Resources.Strings.Generic_Error;
        ArtistName = string.Empty;
        AlbumArtists = new List<AlbumArtist>();
        TotalItemsText = Resonance.WinUI.Resources.Strings.Generic_Error;
        Songs.Clear();
    }
    ...
    private void RefreshAlbumDetailsText()
    {
        ...
        var songCountText = _totalSongCount == 1
            ? ResourceFormatter.Format(Resonance.WinUI.Resources.Strings.AlbumView_SongCount_Singular, _totalSongCount)
            : ResourceFormatter.Format(Resonance.WinUI.Resources.Strings.AlbumView_SongCount_Plural, _totalSongCount);
...
public class DiscHeader
{
    ...
    public string Title => string.Format(Resonance.WinUI.Resources.Strings.AlbumView_DiscHeader, DiscNumber);
}
