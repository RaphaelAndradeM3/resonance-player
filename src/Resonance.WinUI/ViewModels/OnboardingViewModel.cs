...
{
    private static string InitialWelcomeMessage => Resonance.WinUI.Resources.Strings.Onboarding_Welcome;
    ...
    private async Task AddFolder()
    {
        ...
        IsAddingFolder = true;
        StatusMessage = Resonance.WinUI.Resources.Strings.Onboarding_WaitingForSelection;
        ...
        try
        {
            ...
            if (folderPath != null)
            {
                ...
                IsParsing = true;
                StatusMessage = Resonance.WinUI.Resources.Strings.Onboarding_BuildingLibrary;
        ...
        {
            StatusMessage = Resonance.WinUI.Resources.Strings.Onboarding_Error;
