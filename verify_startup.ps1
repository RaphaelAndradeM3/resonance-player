...
# ── 1. Build ──────────────────────────────────────────────────────────────────
Write-Host "[verify] Building Resonance.WinUI..." -ForegroundColor Cyan
...
& $msbuild src\Resonance.WinUI\Resonance.WinUI.csproj /p:Configuration=Debug /p:Platform=x64 /v:m /nologo
...
$buildOut = "src\Resonance.WinUI\bin\x64\Debug\net10.0-windows10.0.26100\win-x64"
