...
public sealed partial class LibraryPage : Page
{
    ...
    private void OnPageLoaded(object sender, RoutedEventArgs e)
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, _isSearchExpanded
            ? Resonance.WinUI.Resources.Strings.LibraryPage_SearchButton_Close_ToolTip
            : Resonance.WinUI.Resources.Strings.LibraryPage_SearchButton_Search_ToolTip);
    ...
    private void ExpandSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Resonance.WinUI.Resources.Strings.LibraryPage_SearchButton_Close_ToolTip);
    ...
    private void CollapseSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Resonance.WinUI.Resources.Strings.LibraryPage_SearchButton_Search_ToolTip);
                ...
                .FirstOrDefault(item => item.Name == "AddToPlaylistSubMenu") is { } addToPlaylistSubMenu)
        {
            ...
            if (ViewModel.AvailablePlaylists.Any())
                ...
                addToPlaylistSubMenu.Items.Add(
                    new MenuFlyoutItem { Text = Resonance.WinUI.Resources.Strings.LibraryPage_PlaylistMenu_NoPlaylists, IsEnabled = false });
        }
