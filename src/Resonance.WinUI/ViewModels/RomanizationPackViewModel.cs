...
public partial class RomanizationPackViewModel : ObservableObject
{
    ...
    public string LicenseText => string.IsNullOrWhiteSpace(License)
        ? string.Empty
        : string.Format(Resonance.WinUI.Resources.Strings.SettingsPage_RomanizationPack_LicenseFormat, License);
    ...
    public string StatusText
    {
        get
        {
            if (IsUpdateAvailable) return Resonance.WinUI.Resources.Strings.SettingsPage_RomanizationPack_UpdateAvailable;
            if (IsInstalled) return string.Format(Resonance.WinUI.Resources.Strings.SettingsPage_RomanizationPack_InstalledFormat, InstalledVersion);
            return Resonance.WinUI.Resources.Strings.SettingsPage_RomanizationPack_NotInstalled;
        }
    }
