...
namespace Resonance.Core.Resources;

/// <summary>
///     Provides thread-safe access to the localized strings for the Resonance.Core library.
/// </summary>
public static class Strings
{
    private static readonly ResourceManager _resourceManager =
        new("Resonance.Core.Resources.Strings", typeof(Strings).Assembly);
