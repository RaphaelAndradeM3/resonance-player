...
public sealed partial class FolderPage : Page
{
    ...
    private async Task ShowDeleteFolderConfirmationDialogAsync(FolderViewModelItem folderItem)
    {
        ...
        {
            Title = Resonance.WinUI.Resources.Strings.FolderPage_DeleteDialog_Title,
            Content = string.Format(Resonance.WinUI.Resources.Strings.FolderPage_DeleteDialog_Format, folderItem.Name),
            PrimaryButtonText = Resonance.WinUI.Resources.Strings.FolderPage_DeleteDialog_PrimaryButton,
            CloseButtonText = Resonance.WinUI.Resources.Strings.FolderPage_DeleteDialog_CloseButton,
