# Contract: `IMetadataEnrichmentService`

**Namespace**: `Resonance.Core.Services.Abstractions`  
**Implements**: Domain Metadata Merge Engine & Proposal Generator  
...
public interface IMetadataEnrichmentService
{
    ...
    /// <summary>
    ///     Merges local genre with remote tags using semantic deduplication.
    /// </summary>
