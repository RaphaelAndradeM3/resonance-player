...
public sealed partial class ArtistViewPage : Page
{
    ...
    private void ExpandSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Resonance.WinUI.Resources.Strings.ArtistViewPage_SearchButton_Close_ToolTip);
    ...
    private void CollapseSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Resonance.WinUI.Resources.Strings.ArtistViewPage_SearchButton_Search_ToolTip);
    ...
    private void PopulatePlaylistSubMenu(MenuFlyoutSubItem subMenu)
    {
        ...
        if (availablePlaylists?.Any() != true)
        {
            ...
            var disabledItem = new MenuFlyoutItem { Text = Resonance.WinUI.Resources.Strings.ArtistViewPage_PlaylistMenu_NoPlaylists, IsEnabled = false };
