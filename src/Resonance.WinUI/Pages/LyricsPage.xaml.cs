...
public sealed partial class LyricsPage : Page
{
    ...
    private async void EditLyricsButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        var editor = new TextBox
        {
            AcceptsReturn = true,
            Text = originalLyrics,
            PlaceholderText = Resonance.WinUI.Resources.Strings.LyricsPage_EditLyrics_Placeholder,
        ...
        {
            Title = Resonance.WinUI.Resources.Strings.LyricsPage_EditLyrics_Title,
            Content = editor,
            PrimaryButtonText = Resonance.WinUI.Resources.Strings.LyricsPage_EditLyrics_Save,
            SecondaryButtonText = ViewModel.CanRemoveLyrics
                ? Resonance.WinUI.Resources.Strings.LyricsPage_EditLyrics_Remove
                : string.Empty,
        ...
        catch (Exception ex)
        {
            ...
            {
                Title = Resonance.WinUI.Resources.Strings.LyricsPage_EditLyrics_Error_Title,
                Content = Resonance.WinUI.Resources.Strings.LyricsPage_EditLyrics_Error_Message,
                CloseButtonText = Resonance.WinUI.Resources.Strings.Generic_OK,
                XamlRoot = XamlRoot
            };
