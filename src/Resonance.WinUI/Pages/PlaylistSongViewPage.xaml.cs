...
public sealed partial class PlaylistSongViewPage : Page
{
    ...
    public PlaylistSongViewPage()
    {
        ...
        ViewModel = App.Services!.GetRequiredService<IViewModelFactory>().Create<PlaylistSongListViewModel>();
    ...
    protected override async void OnNavigatedTo(NavigationEventArgs e)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                await ViewModel.InitializeAsync(Resonance.WinUI.Resources.Strings.PlaylistSongViewPage_UnknownPlaylist, null);
            }
        }
        catch (Exception ex)
        {
    ...
    private void ExpandSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Resonance.WinUI.Resources.Strings.PlaylistSongViewPage_SearchButton_Close_ToolTip);
    ...
    private void CollapseSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Resonance.WinUI.Resources.Strings.PlaylistSongViewPage_SearchButton_Search_ToolTip);
