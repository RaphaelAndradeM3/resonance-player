...
namespace Resonance.WinUI.Resources;

/// <summary>
///     Provides thread-safe access to the localized strings for the Resonance.WinUI project.
/// </summary>
public static class Strings
{
    public static readonly ResourceManager ResourceManager =
        new("Resonance.WinUI.Resources.Strings", typeof(Strings).Assembly);
