...
public sealed partial class AlbumViewPage : Page
{
    ...
    private void ExpandSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Resonance.WinUI.Resources.Strings.AlbumViewPage_SearchButton_Close_ToolTip);
    ...
    private void CollapseSearch()
    {
        ...
        ToolTipService.SetToolTip(SearchToggleButton, Resonance.WinUI.Resources.Strings.AlbumViewPage_SearchButton_Search_ToolTip);
    ...
    private void PopulatePlaylistSubMenu(MenuFlyoutSubItem subMenu)
    {
        ...
        if (availablePlaylists?.Any() != true)
        {
            ...
            var disabledItem = new MenuFlyoutItem { Text = Resonance.WinUI.Resources.Strings.AlbumViewPage_PlaylistMenu_NoPlaylists, IsEnabled = false };
