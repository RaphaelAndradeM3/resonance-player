...
using Resonance.Core.Services.Implementations.Presence;
using Resonance.Core.Services.Implementations.Romanization;
using Resonance.WinUI.Helpers;
using Resonance.WinUI.Pages;
using Resonance.WinUI.Services.Abstractions;
using Resonance.WinUI.Services.Implementations;
...
public partial class App : Application
{
    ...
    /// </summary>
    private static async Task BackfillSortKeysAsync(Resonance.Core.Data.MusicDbContext dbContext)
    {
        ...
        if (string.IsNullOrWhiteSpace(logContent))
            ...
            catch (Exception fileEx)
            {
                logContent = string.Format(
                    Resonance.WinUI.Resources.Strings.App_CrashReport_LogFallbackError_Format,
                    originalLogPath,
                    fileEx.Message);
            }
