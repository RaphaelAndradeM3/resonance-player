...
public static class ArtistMenuFlyoutHelper
{
        ...
        ILogger logger)
    {
        ...
        var loadingItem = new MenuFlyoutItem { Text = Resonance.WinUI.Resources.Strings.Status_Loading, IsEnabled = false };
        ...
        ILogger logger)
    {
        ...
        catch (Exception ex)
        {
            ...
            dispatcherQueue.TryEnqueue(() =>
            {
                if (subMenu.Items.Contains(loadingItem)) loadingItem.Text = Resonance.WinUI.Resources.Strings.Error_FailedToLoadArtists;
            });
        }
    }
