...
namespace Resonance.WinUI.Converters;

public sealed class PageSizeLabelConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, string language) =>
        value is 0 ? Resonance.WinUI.Resources.Strings.PaginationControl_All : value?.ToString() ?? string.Empty;
...
public class ElementThemeToFriendlyStringConverter : IValueConverter
{
    ...
    {
        { ElementTheme.Light, Resonance.WinUI.Resources.Strings.Theme_Light },
        { ElementTheme.Dark, Resonance.WinUI.Resources.Strings.Theme_Dark },
        { ElementTheme.Default, Resonance.WinUI.Resources.Strings.Theme_Default }
    };
...
public class BackdropMaterialToStringConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, string language)
    {
        if (value is BackdropMaterial material)
            ...
            {
                BackdropMaterial.Mica => Resonance.WinUI.Resources.Strings.Backdrop_Mica,
                BackdropMaterial.MicaAlt => Resonance.WinUI.Resources.Strings.Backdrop_MicaAlt,
                BackdropMaterial.Acrylic => Resonance.WinUI.Resources.Strings.Backdrop_Acrylic,
                _ => material.ToString()
            };
        return string.Empty;
    }
...
public class PlayerBackgroundMaterialToStringConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, string language)
    {
        if (value is PlayerBackgroundMaterial material)
            return material switch
            {
                PlayerBackgroundMaterial.Acrylic => Resonance.WinUI.Resources.Strings.PlayerBackgroundMaterial_Acrylic,
                PlayerBackgroundMaterial.Solid => Resonance.WinUI.Resources.Strings.PlayerBackgroundMaterial_Solid,
                _ => material.ToString()
            };
        return string.Empty;
    }
